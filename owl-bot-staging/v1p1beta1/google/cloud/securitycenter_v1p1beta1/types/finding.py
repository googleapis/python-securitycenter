...
class Finding(proto.Message):
    ...
    source_properties = proto.MapField(proto.STRING, proto.MESSAGE, number=7,
    ...
    event_time = proto.Field(proto.MESSAGE, number=9,
    ...
    severity = proto.Field(proto.ENUM, number=13,
        enum=Severity,
    )
