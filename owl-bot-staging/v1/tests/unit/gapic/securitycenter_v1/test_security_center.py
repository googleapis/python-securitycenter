...
def test_bulk_mute_findings(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.bulk_mute_findings),
            '__call__') as call:
...
@pytest.mark.asyncio
async def test_bulk_mute_findings_async(transport: str = 'grpc_asyncio', request_type=securitycenter_service.BulkMuteFindingsRequest):
...
def test_create_mute_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_mute_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_create_mute_config_async(transport: str = 'grpc_asyncio', request_type=securitycenter_service.CreateMuteConfigRequest):
    client = SecurityCenterAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(gcs_mute_config.MuteConfig(
            name='name_value',
            display_name='display_name_value',
            description='description_value',
            filter='filter_value',
...
def test_delete_mute_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_mute_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_delete_mute_config_async(transport: str = 'grpc_asyncio', request_type=securitycenter_service.DeleteMuteConfigRequest):
    client = SecurityCenterAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_big_query_export(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_big_query_export),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_big_query_export_async(transport: str = 'grpc_asyncio', request_type=securitycenter_service.GetBigQueryExportRequest):
    client = SecurityCenterAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(bigquery_export.BigQueryExport(
            name='name_value',
            description='description_value',
            filter='filter_value',
            dataset='dataset_value',
...
def test_get_mute_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_mute_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_mute_config_async(transport: str = 'grpc_asyncio', request_type=securitycenter_service.GetMuteConfigRequest):
    client = SecurityCenterAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(mute_config.MuteConfig(
            name='name_value',
            display_name='display_name_value',
            description='description_value',
            filter='filter_value',
...
@pytest.mark.asyncio
async def test_list_mute_configs_async(transport: str = 'grpc_asyncio', request_type=securitycenter_service.ListMuteConfigsRequest):
    client = SecurityCenterAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(securitycenter_service.ListMuteConfigsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_mute_configs_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, mute_config.MuteConfig)
                   for i in results)
...
async def test_list_mute_configs_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_mute_configs(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_set_mute(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.set_mute),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = finding.Finding(
            name='name_value',
...
@pytest.mark.asyncio
async def test_set_mute_async(transport: str = 'grpc_asyncio', request_type=securitycenter_service.SetMuteRequest):
    client = SecurityCenterAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_mute_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_mute_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = gcs_mute_config.MuteConfig(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_mute_config_async(transport: str = 'grpc_asyncio', request_type=securitycenter_service.UpdateMuteConfigRequest):
    client = SecurityCenterAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_big_query_export(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_big_query_export),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = bigquery_export.BigQueryExport(
            name='name_value',
...
@pytest.mark.asyncio
async def test_create_big_query_export_async(transport: str = 'grpc_asyncio', request_type=securitycenter_service.CreateBigQueryExportRequest):
    client = SecurityCenterAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_big_query_export(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_big_query_export),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_delete_big_query_export_async(transport: str = 'grpc_asyncio', request_type=securitycenter_service.DeleteBigQueryExportRequest):
    client = SecurityCenterAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_big_query_export(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_big_query_export),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = bigquery_export.BigQueryExport(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_big_query_export_async(transport: str = 'grpc_asyncio', request_type=securitycenter_service.UpdateBigQueryExportRequest):
    client = SecurityCenterAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_big_query_exports_async(transport: str = 'grpc_asyncio', request_type=securitycenter_service.ListBigQueryExportsRequest):
    client = SecurityCenterAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_big_query_exports_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, bigquery_export.BigQueryExport)
                   for i in results)
...
async def test_list_big_query_exports_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_big_query_exports(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_bulk_mute_findings_rest_required_fields(request_type=securitycenter_service.BulkMuteFindingsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).bulk_mute_findings._get_unset_required_fields(jsonified_request)
...
def test_bulk_mute_findings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.SecurityCenterRestInterceptor, "post_bulk_mute_findings") as post, \
         mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_bulk_mute_findings") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = securitycenter_service.BulkMuteFindingsRequest.pb(securitycenter_service.BulkMuteFindingsRequest())
        ...
        client.bulk_mute_findings(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_bulk_mute_findings_rest_bad_request(transport: str = 'rest', request_type=securitycenter_service.BulkMuteFindingsRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_bulk_mute_findings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{parent=organizations/*}/findings:bulkMute" % client.transport._host, args[1])
...
def test_create_source_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=organizations/*}/sources" % client.transport._host, args[1])
...
def test_create_finding_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=organizations/*/sources/*}/findings" % client.transport._host, args[1])
...
def test_create_mute_config_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'organizations/sample1'}
    request_init["mute_config"] = {'name': 'name_value', 'display_name': 'display_name_value', 'description': 'description_value', 'filter': 'filter_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'most_recent_editor': 'most_recent_editor_value'}
    request = request_type(**request_init)
...
def test_create_mute_config_rest_required_fields(request_type=securitycenter_service.CreateMuteConfigRequest):
    transport_class = transports.SecurityCenterRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_mute_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_mute_config_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("muteConfigId", )) & set(("parent", "muteConfig", "muteConfigId", )))
...
def test_create_mute_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SecurityCenterRestInterceptor, "post_create_mute_config") as post, \
         mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_create_mute_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = securitycenter_service.CreateMuteConfigRequest.pb(securitycenter_service.CreateMuteConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gcs_mute_config.MuteConfig.to_json(gcs_mute_config.MuteConfig())
        ...
        client.create_mute_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_mute_config_rest_bad_request(transport: str = 'rest', request_type=securitycenter_service.CreateMuteConfigRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_mute_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=organizations/*}/muteConfigs" % client.transport._host, args[1])
...
def test_create_notification_config_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'organizations/sample1'}
    request_init["notification_config"] = {'name': 'name_value', 'description': 'description_value', 'pubsub_topic': 'pubsub_topic_value', 'service_account': 'service_account_value', 'streaming_config': {'filter': 'filter_value'}}
    request = request_type(**request_init)
...
def test_create_notification_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=organizations/*}/notificationConfigs" % client.transport._host, args[1])
...
def test_delete_mute_config_rest_required_fields(request_type=securitycenter_service.DeleteMuteConfigRequest):
    transport_class = transports.SecurityCenterRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_mute_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_mute_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_delete_mute_config") as pre:
        pre.assert_not_called()
        pb_message = securitycenter_service.DeleteMuteConfigRequest.pb(securitycenter_service.DeleteMuteConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_mute_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_delete_mute_config_rest_bad_request(transport: str = 'rest', request_type=securitycenter_service.DeleteMuteConfigRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_mute_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=organizations/*/muteConfigs/*}" % client.transport._host, args[1])
...
def test_delete_notification_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=organizations/*/notificationConfigs/*}" % client.transport._host, args[1])
...
def test_get_big_query_export_rest_required_fields(request_type=securitycenter_service.GetBigQueryExportRequest):
    transport_class = transports.SecurityCenterRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_big_query_export._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_big_query_export_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SecurityCenterRestInterceptor, "post_get_big_query_export") as post, \
         mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_get_big_query_export") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = securitycenter_service.GetBigQueryExportRequest.pb(securitycenter_service.GetBigQueryExportRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = bigquery_export.BigQueryExport.to_json(bigquery_export.BigQueryExport())
        ...
        client.get_big_query_export(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_big_query_export_rest_bad_request(transport: str = 'rest', request_type=securitycenter_service.GetBigQueryExportRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_big_query_export_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=organizations/*/bigQueryExports/*}" % client.transport._host, args[1])
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{resource=organizations/*/sources/*}:getIamPolicy" % client.transport._host, args[1])
...
def test_get_mute_config_rest_required_fields(request_type=securitycenter_service.GetMuteConfigRequest):
    transport_class = transports.SecurityCenterRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_mute_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_mute_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SecurityCenterRestInterceptor, "post_get_mute_config") as post, \
         mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_get_mute_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = securitycenter_service.GetMuteConfigRequest.pb(securitycenter_service.GetMuteConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = mute_config.MuteConfig.to_json(mute_config.MuteConfig())
        ...
        client.get_mute_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_mute_config_rest_bad_request(transport: str = 'rest', request_type=securitycenter_service.GetMuteConfigRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_organization_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=organizations/*/organizationSettings}" % client.transport._host, args[1])
...
def test_get_source_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=organizations/*/sources/*}" % client.transport._host, args[1])
...
def test_group_findings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=organizations/*/sources/*}/findings:group" % client.transport._host, args[1])
...
def test_list_mute_configs_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = securitycenter_service.ListMuteConfigsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_mute_configs_rest_required_fields(request_type=securitycenter_service.ListMuteConfigsRequest):
    transport_class = transports.SecurityCenterRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_mute_configs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_mute_configs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SecurityCenterRestInterceptor, "post_list_mute_configs") as post, \
         mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_list_mute_configs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = securitycenter_service.ListMuteConfigsRequest.pb(securitycenter_service.ListMuteConfigsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = securitycenter_service.ListMuteConfigsResponse.to_json(securitycenter_service.ListMuteConfigsResponse())
        ...
        client.list_mute_configs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_mute_configs_rest_bad_request(transport: str = 'rest', request_type=securitycenter_service.ListMuteConfigsRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_mute_configs_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(securitycenter_service.ListMuteConfigsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_run_asset_discovery_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=organizations/*}/assets:runDiscovery" % client.transport._host, args[1])
...
def test_set_finding_state_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=organizations/*/sources/*/findings/*}:setState" % client.transport._host, args[1])
...
def test_set_mute_rest_required_fields(request_type=securitycenter_service.SetMuteRequest):
    transport_class = transports.SecurityCenterRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).set_mute._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_mute_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("name", "mute", )))
...
def test_set_mute_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SecurityCenterRestInterceptor, "post_set_mute") as post, \
         mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_set_mute") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = securitycenter_service.SetMuteRequest.pb(securitycenter_service.SetMuteRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.set_mute(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_set_mute_rest_bad_request(transport: str = 'rest', request_type=securitycenter_service.SetMuteRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_mute_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=organizations/*/sources/*/findings/*}:setMute" % client.transport._host, args[1])
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{resource=organizations/*/sources/*}:setIamPolicy" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{resource=organizations/*/sources/*}:testIamPermissions" % client.transport._host, args[1])
...
def test_update_external_system_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'external_system': {'name': 'organizations/sample1/sources/sample2/findings/sample3/externalSystems/sample4'}}
    request_init["external_system"] = {'name': 'organizations/sample1/sources/sample2/findings/sample3/externalSystems/sample4', 'assignees': ['assignees_value1', 'assignees_value2'], 'external_uid': 'external_uid_value', 'status': 'status_value', 'external_system_update_time': {'seconds': 751, 'nanos': 543}}
    request = request_type(**request_init)
...
def test_update_external_system_rest_required_fields(request_type=securitycenter_service.UpdateExternalSystemRequest):
    transport_class = transports.SecurityCenterRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_external_system._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_external_system_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SecurityCenterRestInterceptor, "post_update_external_system") as post, \
         mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_update_external_system") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = securitycenter_service.UpdateExternalSystemRequest.pb(securitycenter_service.UpdateExternalSystemRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gcs_external_system.ExternalSystem.to_json(gcs_external_system.ExternalSystem())
        ...
        client.update_external_system(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_external_system_rest_bad_request(transport: str = 'rest', request_type=securitycenter_service.UpdateExternalSystemRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_external_system_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'external_system': {'name': 'organizations/sample1/sources/sample2/findings/sample3/externalSystems/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{external_system.name=organizations/*/sources/*/findings/*/externalSystems/*}" % client.transport._host, args[1])
...
def test_update_finding_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{finding.name=organizations/*/sources/*/findings/*}" % client.transport._host, args[1])
...
def test_update_mute_config_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'mute_config': {'name': 'organizations/sample1/muteConfigs/sample2'}}
    request_init["mute_config"] = {'name': 'organizations/sample1/muteConfigs/sample2', 'display_name': 'display_name_value', 'description': 'description_value', 'filter': 'filter_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'most_recent_editor': 'most_recent_editor_value'}
    request = request_type(**request_init)
...
def test_update_mute_config_rest_required_fields(request_type=securitycenter_service.UpdateMuteConfigRequest):
    transport_class = transports.SecurityCenterRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_mute_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_mute_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SecurityCenterRestInterceptor, "post_update_mute_config") as post, \
         mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_update_mute_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = securitycenter_service.UpdateMuteConfigRequest.pb(securitycenter_service.UpdateMuteConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_mute_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_mute_config_rest_bad_request(transport: str = 'rest', request_type=securitycenter_service.UpdateMuteConfigRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_mute_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'mute_config': {'name': 'organizations/sample1/muteConfigs/sample2'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{mute_config.name=organizations/*/muteConfigs/*}" % client.transport._host, args[1])
...
def test_update_notification_config_rest(request_type):
    ...
    request_init["notification_config"] = {'name': 'organizations/sample1/notificationConfigs/sample2', 'description': 'description_value', 'pubsub_topic': 'pubsub_topic_value', 'service_account': 'service_account_value', 'streaming_config': {'filter': 'filter_value'}}
    request = request_type(**request_init)
...
def test_update_notification_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{notification_config.name=organizations/*/notificationConfigs/*}" % client.transport._host, args[1])
...
def test_update_organization_settings_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{organization_settings.name=organizations/*/organizationSettings}" % client.transport._host, args[1])
...
def test_update_source_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{source.name=organizations/*/sources/*}" % client.transport._host, args[1])
...
def test_update_security_marks_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{security_marks.name=organizations/*/assets/*/securityMarks}" % client.transport._host, args[1])
...
def test_create_big_query_export_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'organizations/sample1'}
    request_init["big_query_export"] = {'name': 'name_value', 'description': 'description_value', 'filter': 'filter_value', 'dataset': 'dataset_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'most_recent_editor': 'most_recent_editor_value', 'principal': 'principal_value'}
    request = request_type(**request_init)
...
def test_create_big_query_export_rest_required_fields(request_type=securitycenter_service.CreateBigQueryExportRequest):
    transport_class = transports.SecurityCenterRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_big_query_export._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_big_query_export_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("bigQueryExportId", )) & set(("parent", "bigQueryExport", "bigQueryExportId", )))
...
def test_create_big_query_export_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SecurityCenterRestInterceptor, "post_create_big_query_export") as post, \
         mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_create_big_query_export") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = securitycenter_service.CreateBigQueryExportRequest.pb(securitycenter_service.CreateBigQueryExportRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_big_query_export(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_big_query_export_rest_bad_request(transport: str = 'rest', request_type=securitycenter_service.CreateBigQueryExportRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_big_query_export_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=organizations/*}/bigQueryExports" % client.transport._host, args[1])
...
def test_delete_big_query_export_rest_required_fields(request_type=securitycenter_service.DeleteBigQueryExportRequest):
    transport_class = transports.SecurityCenterRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_big_query_export._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_big_query_export_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_delete_big_query_export") as pre:
        pre.assert_not_called()
        pb_message = securitycenter_service.DeleteBigQueryExportRequest.pb(securitycenter_service.DeleteBigQueryExportRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_big_query_export(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_delete_big_query_export_rest_bad_request(transport: str = 'rest', request_type=securitycenter_service.DeleteBigQueryExportRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_big_query_export_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'big_query_export': {'name': 'organizations/sample1/bigQueryExports/sample2'}}
    request_init["big_query_export"] = {'name': 'organizations/sample1/bigQueryExports/sample2', 'description': 'description_value', 'filter': 'filter_value', 'dataset': 'dataset_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'most_recent_editor': 'most_recent_editor_value', 'principal': 'principal_value'}
    request = request_type(**request_init)
...
def test_update_big_query_export_rest_required_fields(request_type=securitycenter_service.UpdateBigQueryExportRequest):
    transport_class = transports.SecurityCenterRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_big_query_export._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_big_query_export_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SecurityCenterRestInterceptor, "post_update_big_query_export") as post, \
         mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_update_big_query_export") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = securitycenter_service.UpdateBigQueryExportRequest.pb(securitycenter_service.UpdateBigQueryExportRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_big_query_export(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_big_query_export_rest_bad_request(transport: str = 'rest', request_type=securitycenter_service.UpdateBigQueryExportRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_big_query_export_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'big_query_export': {'name': 'organizations/sample1/bigQueryExports/sample2'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{big_query_export.name=organizations/*/bigQueryExports/*}" % client.transport._host, args[1])
...
def test_list_big_query_exports_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = securitycenter_service.ListBigQueryExportsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_big_query_exports_rest_required_fields(request_type=securitycenter_service.ListBigQueryExportsRequest):
    transport_class = transports.SecurityCenterRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_big_query_exports._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_big_query_exports_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SecurityCenterRestInterceptor, "post_list_big_query_exports") as post, \
         mock.patch.object(transports.SecurityCenterRestInterceptor, "pre_list_big_query_exports") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = securitycenter_service.ListBigQueryExportsRequest.pb(securitycenter_service.ListBigQueryExportsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = securitycenter_service.ListBigQueryExportsResponse.to_json(securitycenter_service.ListBigQueryExportsResponse())
        ...
        client.list_big_query_exports(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_big_query_exports_rest_bad_request(transport: str = 'rest', request_type=securitycenter_service.ListBigQueryExportsRequest):
    client = SecurityCenterClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_big_query_exports_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(securitycenter_service.ListBigQueryExportsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_security_center_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.securitycenter_v1.services.security_center.transports.SecurityCenterTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_security_center_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.securitycenter_v1.services.security_center.transports.SecurityCenterTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.SecurityCenterTransport()
        adc.assert_called_once()
...
def test_big_query_export_path():
    organization = "oyster"
    export = "nudibranch"
    expected = "organizations/{organization}/bigQueryExports/{export}".format(organization=organization, export=export, )
...
def test_cancel_operation_rest_bad_request(transport: str = 'rest', request_type=operations_pb2.CancelOperationRequest):
    ...
    request = request_type()
    request = json_format.ParseDict({'name': 'organizations/sample1/operations/sample2'}, request)
...
def test_list_operations_rest_bad_request(transport: str = 'rest', request_type=operations_pb2.ListOperationsRequest):
    ...
    request = request_type()
    request = json_format.ParseDict({'name': 'organizations/sample1/operations'}, request)
