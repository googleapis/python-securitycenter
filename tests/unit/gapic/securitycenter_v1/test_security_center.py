...
def test_create_notification_config(transport: str = "grpc"):
    client = SecurityCenterClient(
        credentials=credentials.AnonymousCredentials(), transport=transport,
    )
...
def test_delete_notification_config(transport: str = "grpc"):
    client = SecurityCenterClient(
        credentials=credentials.AnonymousCredentials(), transport=transport,
    )
...
def test_get_notification_config(transport: str = "grpc"):
    client = SecurityCenterClient(
        credentials=credentials.AnonymousCredentials(), transport=transport,
    )
...
def test_list_notification_configs(transport: str = "grpc"):
    client = SecurityCenterClient(
        credentials=credentials.AnonymousCredentials(), transport=transport,
    )
...
async def test_list_notification_configs_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page in (await client.list_notification_configs(request={})).pages:
            pages.append(page)
        for page, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page.raw_page.next_page_token == token
...
def test_update_notification_config(transport: str = "grpc"):
    client = SecurityCenterClient(
        credentials=credentials.AnonymousCredentials(), transport=transport,
    )
...
def test_security_center_transport_auth_adc():
    ...
    with mock.patch.object(auth, "default") as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transports.SecurityCenterGrpcTransport(host="squid.clam.whelk")
        adc.assert_called_once_with(
            scopes=("https://www.googleapis.com/auth/cloud-platform",)
        )
