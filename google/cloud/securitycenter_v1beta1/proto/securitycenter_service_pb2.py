...
GroupAssetsRequest = _reflection.GeneratedProtocolMessageType('GroupAssetsRequest', (_message.Message,), {
  ...
  Attributes:
      ...
      filter:
          ...
          without quotes.  For example, ``resource_properties.size =
      ...
      group_by:
          ...
          security_center_properties.resource_parent  The following
      ...
      compare_duration:
          ...
          remained present during the compare_duration period of time
          that precedes the read_time. This is the time between
          (read_time - compare_duration) and read_time.  The state value
          is derived based on the presence of the asset at the two
          ...
          compare_duration and    reference_time.  This field is ignored
