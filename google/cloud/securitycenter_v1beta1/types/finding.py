...
class Finding(proto.Message):
    r"""Cloud Security Command Center (Cloud SCC) finding.
    A finding is a record of assessment data (security, risk, health
    or privacy) ingested into Cloud SCC for presentation,
    notification, analysis, policy testing, and enforcement. For
    example, an XSS vulnerability in an App Engine application is a
    finding.
    ...
    Attributes:
        ...
        resource_name (str):
            ...
            When the finding is for a non-GCP resource, the resourceName
            can be a customer or partner defined string. This field is
        ...
        external_uri (str):
            ...
            page outside of Cloud SCC where additional
            information about the finding can be found. This
            field is guaranteed to be either empty or a well
            formed URL.
