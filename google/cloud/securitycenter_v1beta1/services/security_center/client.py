...
class SecurityCenterClient(metaclass=SecurityCenterClientMeta):
    ...
    def create_source(
        ...
        *,
        ...
        Returns:
            ~.gcs_source.Source:
                Cloud Security Command Center's
                (Cloud SCC) finding source. A finding
                source is an entity or a mechanism that
                can produce a finding. A source is like
                a container of findings that come from
                the same scanner, logger, monitor, etc.
        ...
        *,
        ...
        Returns:
            ~.gcs_finding.Finding:
                ...
                ingested into Cloud SCC for
                presentation, notification, analysis,
                policy testing, and enforcement. For
                example, an XSS vulnerability in an App
        ...
        *,
        ...
        Returns:
            ~.organization_settings.OrganizationSettings:
                ...
                attached to the Cloud Security Command
    ...
    def get_source(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method.wrap_method(
            self._transport.get_source, default_timeout=None, client_info=_client_info,
        )
    ...
    def list_assets(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = gapic_v1.method.wrap_method(
            self._transport.list_assets, default_timeout=None, client_info=_client_info,
        )
        ...
        *,
        ...
        Returns:
            ~.gcs_security_marks.SecurityMarks:
                ...
                are attached to the parent Cloud
                Security Command Center (Cloud SCC)
                resource. Security marks are scoped
                within a Cloud SCC organization -- they
                can be modified and viewed by all users
                who have proper permissions on the
                organization.
